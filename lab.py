...
def main():
    ...
    node1 = net.create_node('Node0', image='madt/kind', entrypoint="sleep infinity", ports={'8008/tcp': 8008, '9080/tcp': 9080, '32325/tcp': 32325}, enable_internet=True, privileged=True)
